...
<main class="page-center">
  <article class="sign-up">
    ...
    <form class="sign-up-form form" action="./action/proses-regis-dosen.php" method="POST">
      <label class="form-label-wrapper">
        <p class="form-label">NIDN </p>
        <input class="form-input" type="text" name="nidn" placeholder="Masukkan NIDN" required  autocomplete="none">
      </label>
      <label class="form-label-wrapper">
