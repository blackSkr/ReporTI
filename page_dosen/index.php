...
// Memeriksa apakah user sudah login sebagai dosen
if (!isset($_SESSION['nidn']) || $_SESSION['user_type'] !== 'dosen') {
    // Jika tidak ada session nidn atau bukan dosen, arahkan ke halaman login
    echo "<script>alert('Anda harus login terlebih dahulu sebagai dosen!'); window.location.href='../index.php';</script>";
    exit();
}

// Mengambil NIDN dari session
$nidn = $_SESSION['nidn'];
$nama_dosen = $_SESSION['user_dosen'];
...
<div class="page-flex">
  ...
  <div class="container main-nav">
    ...
    <main class="main users chart-page" id="skip-target">
      <div class="container">
        <h2 class="main-title">Selamat Datang <?php echo htmlspecialchars($_SESSION['user_dosen']); ?> !</h2>
        <!-- hitung data -->
                        ...
                        echo "<td>
                                <span class='p-relative'>
                                    ...
                                    <ul class='users-item-dropdown dropdown'>
                                        <li><a href='../actiondosen/dosen-proses-hapus-laporan.php?id_laporan=" . $row['id_laporan'] . "' onclick='return confirm(\"Apakah Anda yakin ingin menghapus laporan ini?\")'>Hapus</a></li>
                                    </ul>
                                </span>
                              </td>";
                        echo "</tr>";
