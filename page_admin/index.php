                ...
                <li>
                    ...
                    <ul class="cat-sub-menu">
                        <li>
                            ...
                            <a href="../registrasiadmin.php">Registrasi Admin</a>
                        </li>
                    </ul>
                </li>
            </ul>
      ...
      <div class="nav-user-wrapper">
        <button href="##" class="nav-user-btn dropdown-btn" title="My profile" type="button">
          ...
          <span class="nav-user-img">
            <picture><source srcset="../img/avatar/avatar-2.svg" type="image/webp"><img src="./img/avatar/avatar-illustrated-02.png" alt="User name"></picture>
          </span>
        </button>
...
function showImageInModal(imgSrc) {
  ...
  modalImg.src = imgSrc; // Mengganti sumber gambar di modal
}
...
<script>
  function showImageInModal(imgSrc) {
    ...
    modalImage.src = imgSrc; // Set the source of the image in the modal
